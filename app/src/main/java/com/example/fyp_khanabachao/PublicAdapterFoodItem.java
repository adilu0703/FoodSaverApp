...
public class PublicAdapterFoodItem extends RecyclerView.Adapter<FoodViewHolderPublic>
{
    private Context mcontext;
    private List<FoodDataModelClass> myfoodlist;

    public PublicAdapterFoodItem(Context mcontext, List<FoodDataModelClass> myfoodlist) {
    ...
    @NonNull
    @Override
    public FoodViewHolderPublic onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType)
    {
        View mview = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycler_row_public_fooditem,viewGroup,false);
        return new FoodViewHolderPublic(mview);
    }

    @Override
    public void onBindViewHolder(@NonNull FoodViewHolderPublic foodViewHolder, int i)
    {
        ...
        foodViewHolder.mcardView.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(mcontext,FoodDetailPublic.class);
...
class FoodViewHolderPublic extends RecyclerView.ViewHolder
{
    ...
    public FoodViewHolderPublic(@NonNull View itemView)
    {
        super(itemView);
