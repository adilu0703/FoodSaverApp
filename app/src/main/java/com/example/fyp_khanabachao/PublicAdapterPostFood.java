...
public class PublicAdapterPostFood extends RecyclerView.Adapter<PostFoodViewHolderPublic>{
    private Context PLcontext;
    private List<PostFoodDataModelClass> PLfoodlist;

    public PublicAdapterPostFood(Context PLcontext, List<PostFoodDataModelClass> PLfoodlist) {
    ...
    @NonNull
    @Override
    public PostFoodViewHolderPublic onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        return new PostFoodViewHolderPublic(PLmview);
    }

    @Override
    public void onBindViewHolder(@NonNull PostFoodViewHolderPublic postfoodViewHolder, int i) {
        ...
        postfoodViewHolder.plcardView.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(PLcontext,PostFoodDetailPublic.class);
...
class PostFoodViewHolderPublic extends RecyclerView.ViewHolder
{

    TextView plTitle , plQuantity, plTime,plAddress, plCity;
    CardView plcardView;

    public PostFoodViewHolderPublic(@NonNull View itemView)
    {
        super(itemView);
