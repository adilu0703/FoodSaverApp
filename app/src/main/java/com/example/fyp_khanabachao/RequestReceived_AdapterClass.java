...
public class RequestReceived_AdapterClass extends RecyclerView.Adapter<RequestViewHolder>
{

    private Context mcontext;
    private List<FoodDataModelClass> myfoodlist;

    public RequestReceived_AdapterClass(Context mcontext, List<FoodDataModelClass> myfoodlist) {
    ...
    public void onBindViewHolder(@NonNull RequestViewHolder requestViewHolder, int i)
    {
        ...
        requestViewHolder.mcardView.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(mcontext,RequestReceived_MyFoodDetail.class);
