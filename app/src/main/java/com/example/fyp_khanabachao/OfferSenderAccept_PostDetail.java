...
import com.example.fyp_khanabachao.databinding.ActivityOfferSenderAcceptPostDetailBinding;
...
public class OfferSenderAccept_PostDetail extends DrawerBaseActivity {
    ActivityOfferSenderAcceptPostDetailBinding activityOfferSenderAcceptPostDetailBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityOfferSenderAcceptPostDetailBinding= ActivityOfferSenderAcceptPostDetailBinding.inflate(getLayoutInflater());
        setContentView(activityOfferSenderAcceptPostDetailBinding.getRoot());
...
//--------------------------------------------------------
    ...
    public void openChatPostAcceptedRequest(View view) {
